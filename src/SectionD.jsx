...
<div className = "items py-4">
    ...
    <div className = "item-text">
        ...
        <a href="https://elegant-spence-1f45ba.netlify.app/" target="_blank">A-10 LAB</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://cranky-wescoff-fb4651.netlify.com" target="_blank">Bukee</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://cocky-spence-cedba8.netlify.app/" target="_blank">B125 (black version)</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://vibrant-stonebraker-718e7f.netlify.app/" target="_blank">Bankist</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://ecstatic-poincare-15b597.netlify.com" target="_blank">EdgeLedger</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://competent-banach-9fdd6d.netlify.com" target="_blank">Grid News</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://practical-curie-6a7c54.netlify.com" target="_blank">HW-B Hotel</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://zen-hopper-2ebf1f.netlify.com/" target="_blank">Base 4 Simple Presentation</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://competent-bhaskara-328919.netlify.com" target="_blank">Base 4 Timeline</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <h2 className = "item-text-title">
        <a href="https://confident-banach-cc4a1e.netlify.com/" target="_blank">KittyLab</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://confident-mahavira-1727f1.netlify.app/" target="_blank">B125</a>
        </h2>
        </div>
    </div>
    </div>
    ...
    <div className = "item-text">
        ...
        <p className = "item-text-category">Web Site Example</p>
        <h2 className = "item-text-title">
        <a href="https://laughing-poincare-a5b323.netlify.app/" target="_blank">Re:</a>
        </h2>
        </div>
    </div>
    </div>
